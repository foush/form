...
use AutoForm\Exception\Annotation\DuplicateName;
use AutoForm\Exception\Annotation\NoSuchChild;
...
class Element
{
    ...
    const DEFAULT_TEMPLATE = 'autoform/form/element.phtml';
    ...
    /**
     * @param  \AutoForm\Annotation\Form $parentForm
     * @return Element
     */
    public function setParentForm(\AutoForm\Annotation\Form $parentForm)
    {
    ...
    /**
     * @return \AutoForm\Annotation\Form
     */
    ...
    {
        /* @var $entity \AutoForm\Entity\BaseInterface */
