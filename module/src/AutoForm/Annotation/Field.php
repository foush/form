...
use AutoForm\Annotation\Field\Checkbox;
use AutoForm\Annotation\Field\MultiCheckbox;
use AutoForm\Annotation\Field\Radio;
use AutoForm\Annotation\Field\Select;
use AutoForm\Service\EntityToForm;
use Zend\Form\ElementInterface;
use AutoForm\Annotation\Form as AnnotatedForm;
use AutoForm\Annotation\Field\Wysiwyg;

class Field extends Element
{
    const ELEMENT_TYPE = 'field';

    const DEFAULT_TEMPLATE_ELEMENT_LABEL   = 'autoform/form/element/label.phtml';
    const DEFAULT_TEMPLATE_ELEMENT_INPUT   = 'autoform/form/element/input.phtml';
    const DEFAULT_TEMPLATE_ELEMENT_BUTTONS = 'autoform/form/element/buttons.phtml';
    const DEFAULT_TEMPLATE_ELEMENT_HELP    = 'autoform/form/element/help.phtml';
    const DEFAULT_TEMPLATE_ELEMENT_ERROR   = 'autoform/form/element/error.phtml';
    ...
    public function getFullNgModel()
    {
        ...
        $e = $this;
        /* @var $form \AutoForm\Annotation\Form */
    ...
    /**
     * @param \AutoForm\Annotation\strings $ngClick
     */
    ...
    /**
     * @return \AutoForm\Annotation\strings
     */
