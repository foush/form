...
use AutoForm\Exception\Annotation\Subform\GetterDoesNotExist;
use AutoForm\Exception\Annotation\Subform\GetterNotSet;
use AutoForm\Exception\Annotation\Subform\InvalidSubEntity;
...
class Subform extends Field
{
    ...
    const DEFAULT_TEMPLATE = 'autoform/form/children.phtml';
    ...
    public function populateFromParent(Form $annotatedForm, EntityToForm $e2f)
    {
        ...
        if (!$subentity instanceof \AutoForm\Entity\BaseInterface) {
            throw new InvalidSubEntity("Sub entity must implement \\AutoForm\\Entity\\BaseInterface");
        }
        $subform = new \AutoForm\Annotation\Form($subFormElement, $e2f);
